...
GENUINE1 = '/tinygenuine-10.jpg'
GENUINE2 = '/tinygenuine-11.jpg'
FORGED = '/tinyforged-10.jpg'
...
def main():
    ...
    genuine1 = cv2.imread("data/test/029/tinygenuine-10.png")
    genuine2 = cv2.imread("data/test/029/tinygenuine-11.png")
    forged = cv2.imread("data/test/029/tinyforged-10.png")
