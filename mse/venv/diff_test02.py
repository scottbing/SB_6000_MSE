...
GENUINE1 = '/tinygenuine-12.jpg'
GENUINE2 = '/tinygenuine-06.jpg'
FORGED = '/tinyforged-12.jpg'
...
def main():
    ...
    # load image piixels
    with Image.open(test_folder + GENUINE1) as im1:
        imageX = storePixels(im1)
    with Image.open(test_folder + GENUINE2) as im2:
        imageY = storePixels(im2)
    with Image.open(test_folder + FORGED) as im3:
    ...
    genuine1 = cv2.imread("data/test/024/tinygenuine-12.png")
    genuine2 = cv2.imread("data/test/024/tinygenuine-06.png")
    forged = cv2.imread("data/test/024/tinyforged-12.png")
